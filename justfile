...
build-musl:
  CC=x86_64-linux-musl-gcc cargo build --release --target x86_64-unknown-linux-musl -p gittriage

build-musl-debug:
  CC=x86_64-linux-musl-gcc cargo build --target x86_64-unknown-linux-musl -p gittriage
